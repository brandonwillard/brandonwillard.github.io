...
results with the default Theano pretty printer as Equation [[eqref:eq:rv-pprinter-exa]].
#+NAME: rv-theano-pprinter-exa
#+BEGIN_SRC python :eval never-export :results none :wrap "SRC text :eval never" :noweb strip-export
<<new-op-code>>
